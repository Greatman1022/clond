<template>
  <div class="play-video-wrap">
    ...
    <el-dialog title="" :visible.sync="palyVideoVisible" size="full" custom-class="play-video-dialog" :close-on-click-modal="true" :before-close="closePlayVideo" @open="openPlayVideo">
