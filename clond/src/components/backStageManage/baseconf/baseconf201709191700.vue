<template>
  <div id='baseConf'>
    <div class='baseConfNav'>
      <el-menu :default-active="active" class="el-menu-vertical-demo" @select='handleSelete'>
        ...
        <el-menu-item index="3">
          ...
          <i class='iconfont el-icon-wc-xiangshang' v-if='serverStatus == 2'></i>
          <i class='iconfont el-icon-wc-jinggao' v-if='serverStatus == 3'></i>
          <i class='iconfont el-icon-wc-guanji' v-if='serverStatus == 4'></i>
        </el-menu-item>
      </el-menu>
    </div>
    <div class='baseconfR'>
      <div class='bc_block' v-if='navIndex == 1'>
        <h2>小程序信息</h2>
        <div class='bc_item'>
          <p class='p_line'>
            <i class='icon'></i>
        ...
        <div class='bc_item'>
          ...
          <ul>
            ...
            <li>
              ...
              <el-upload class="fileload" accept='.p12' :action="'http://cloud.vdongchina.com/basic/config/certif?bindAppid='+miniApp.appid" name='apiclientCertFile' :disabled='miniADisabled' :show-file-list='false' :on-success='minicertifSuccess' :class='{"btndisabled": miniADisabled==true}'>
      ...
      <div class='bc_block' v-if='navIndex == 2'>
        <h2>公众号管理</h2>
        <div class='bc_item'>
          <p class='p_line'>
            <i class='icon'></i>
        ...
        <div class='bc_item'>
          ...
          <ul>
            ...
            <li>
              ...
              <el-upload class="fileload" accept='.p12' :disabled='wxADisabled' :action="'http://cloud.vdongchina.com/basic/config/certif?bindAppid='+wxApp.appid" name='apiclientCertFile' :show-file-list='false' :on-success='wxcertifSuccess' :class='{"btndisabled": wxADisabled==true}'>
                <el-button>上传文件</el-button>
                <div slot="tip" class="el-upload__tip">只能上传.p12文件，且不超过500kb</div>
              </el-upload>
            </li>
      ...
      <div class='bc_block' v-if='navIndex == 3'>
        <h2>服务器（
          <span v-if='serverStatus == 1'>正常</span>
          <span class='restartColor' v-if='serverStatus == 3'>重启中</span>
          <span class='stopColor' v-if='serverStatus == 4'>已停止</span>
          <span class='updateColor' v-if='serverStatus == 2'>有更新版本</span>）
        </h2>
        <div class='bc_item'>
          <p class='p_line'>
            当前版本 : 1.10 （已经是最新版本）
          ...
          <ul>
            <li>
              <el-button class='baseBtn' :disabled="serverStatus == 1 || serverStatus == 3">重启</el-button> 
            </li>
          </ul>
        </div>
