  ...
  <div class='usermanage'>
    ...
    <div class='um_con'>
      <div class='con_l'>
        ...
        style="width: 100%"
        >
          <el-table-column width="30" label="" prop="id" class-name="first-cell"></el-table-column>
          <el-table-column width="105" label="微信昵称" prop="id" class-name="first-cell"> </el-table-column>
          <el-table-column width="85" label="姓名" prop="productCount"> </el-table-column>
          <el-table-column width="115" label="手机" prop="createDate" :formatter="formatDate" class-name="ell"> </el-table-column>
          <el-table-column label="地址" prop="shipDate" :formatter="formatDate" class-name="ell"> </el-table-column>
          <el-table-column width="165" label="最近一次下单时间" prop="shipCompanyName"> </el-table-column>
          <el-table-column width="90" label="下单总额" prop="shipDeliveryCode" class-name="ell"> </el-table-column>
          <el-table-column width="125" label="分组" prop="status" :formatter="formatStatus"> </el-table-column>
        </el-table>
        <table width='100%'>
          <thead>
            <tr>
          ...
          <tbody>
            <tr v-for='(user,index) in userlist'>
              ...
              <td>
                <span v-text='user.groupName || "未分组"'></span>
                <!-- <el-select v-model="user.groupName" placeholder="请选择">
                  <el-option
...
export default {
  ...
  methods: {
    ...
    /* 移动分组弹窗 */
    openMoveBatchGroupPop: function () {
      this.moveBatchGroupVisible = true
    },
    saveMoveBatchGroupDialog: function () {
    ...
    batchmoveselect: function () {
      // console.log(this.moveBatchGroupValue)
    },

    /* 新建分组弹窗 */
    openMakeGroupPop: function () {
      this.makeGroupVisible = true
      this.makeGroupinput = ''
    },
    saveMakeGroupDialog: function () {
    ...
    /* 删除分组弹窗 */
    openDelGroupPop: function (id, val) {
      this.delGroupVisible = true
      this.groupName = val
      this.groupId = id
    },
    saveDelGroupDialog: function () {
